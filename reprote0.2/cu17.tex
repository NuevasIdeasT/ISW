...
%--------------------------------------
	\begin{UseCase}{CU36}{Modificar Instructor}{
		...
		\UCitem{Errores}{
		 • El actor dejo los campos Nombre y Dirección completamente vacíos.TA-B\newline
		 El actor dejo el campo de “Actividades Asignadas” sin ninguna actividad.TA-?
		}
...
%--------------------------------------
	\begin{UCtrayectoria}{Este caso de uso inicia cuando un actor se encuentra en la pantalla de Instructores "Poner aqui la IU" y tiene una sesión iniciada.}
		...
		\UCpaso permite editar los campos de texto “Nombre” y “Dirección” con caracteres                     libres.
		\UCpaso despliega la pantalla “Editar instructor”.
